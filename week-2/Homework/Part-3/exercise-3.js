...
let coffeeMachine = {
  ...
  getCoffee: function (coffee) {
    ...
    if (!!coffeePrice && this.insertedAmount >= coffeePrice) {
      let change = this.insertedAmount - coffeePrice
    ...
    return {
      message: `Sorry you don't have enough money for a ${coffee}`,
      change: this.insertedAmount
    }
  },
};
